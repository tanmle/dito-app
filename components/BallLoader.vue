<template>
  <div class="main-fader bg-gray-500/[.75] z-999 fixed top-0 left-0 w-full h-full" responsive-height-comments>
    <div class="loader">
      <svg viewBox="0 0 866 866" xmlns="http://www.w3.org/2000/svg" class="fill-blue-500">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 164.83 151.5"
          class="fill-blue-500">
          <path class="path-0 fill-blue-500"
          ...
          <path class="path-3 fill-blue-500"
          ...
          <path class="path-4 fill-blue-500"
          ...
          <path class="path-5 fill-blue-500"
          ...
          <path class="path-6 fill-blue-500"
